...
description: Complete guide to authentication with the Glyfs API
---
...
<Callout type="info">
**Key Concept** - Unlike many APIs that use account-wide keys, Glyfs API keys are scoped to individual agents. This provides better security isolation and access control.
</Callout>
...
See our [Examples](/docs/examples/) documentation for complete code examples showing proper API key usage in various programming languages.