---
title: Invoke API
description: Simple request/response interface for interacting with your AI agents
---
...
<Callout type="note">
**Token Counting** - Token counts are approximated using `length / 4` and may not reflect actual LLM provider token usage.
</Callout>
...
For real-time streaming responses, see the [Streaming API](/docs/api/streaming) documentation.
